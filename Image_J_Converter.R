...
ImageJSample <- read.csv('~/Desktop/GitHub/CF_2022/Image_J/OFAV_SS_9EV41',na.strings=c("",".","NaN"))
...
#Write new csv 
write.csv(x, '~/Desktop/GitHub/CF_2022/RawData/Merged_OFAV_SS_9EV41.csv')
